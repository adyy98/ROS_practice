...
def listener():
    rospy.init_node('listener',
                    anonymous=True)  # We are using this function to tell ROS that this python script will be a node (called listener)
    rospy.Subscriber('chatter', String,
                     callback)  # Creating an instance of a subscriber using this function, where chatter is the name of the topic being subscribed, having data type String, and sending it to callback
    rospy.spin()
